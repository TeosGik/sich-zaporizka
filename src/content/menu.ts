    ...
    subCategories: [
      {
        ...
        title: "Перші страви",
        dishes: [
          { name: "Борщ з пампушками та сметаною", desc: "Варимо 7 годин на яловичих ребрах. Пасеровка на сирому буряку, 4 пухкі пампушки з часниковою олією.", weight: "300/100/30", price: 220, highlight: true },

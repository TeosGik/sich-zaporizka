...
export const zones: readonly Zone[] = [
  ...
  },
  {
    ...
    name: "Шинок",
    description:
      "Камерний підвальний бар з барною стійкою з дубового зрубу. Сорок видів хріновухи, наливки на травах і дим від люльки.",
    capacity: "до 24 осіб",
  ...
  },
  {
    ...
    name: "Літня тераса",
    description:
      "Дерев'яний настил серед саду з гортензіями і соснами. Краще місце Січі для тихого літнього обіду.",
    capacity: "до 60 осіб",

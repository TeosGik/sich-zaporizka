...
export function ZoneCard({ zone }: ZoneCardProps) {
  return (
    <article className="group relative flex flex-col overflow-hidden rounded-lg bg-card shadow-md transition-shadow hover:shadow-xl">
      {/* Фон-плейсхолдер з градієнтом — заміниться на <Image src=... /> */}
      <div className="relative aspect-[3/2] overflow-hidden">
        ...
        <div
          aria-hidden="true"
          className="pointer-events-none absolute inset-x-0 bottom-0 h-1/2 bg-gradient-to-t from-sich-ink/60 to-transparent"
        />
